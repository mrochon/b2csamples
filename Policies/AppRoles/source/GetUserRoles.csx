...
// A more complicated way:  https://docs.microsoft.com/en-us/aspnet/core/performance/caching/memory?view=aspnetcore-5.0#:~:text=Cache%20in-memory%20in%20ASP.NET%20Core%201%20Caching%20basics.,8%20Background%20cache%20update.%20...%209%20Additional%20resources
...
public static async Task<IActionResult> Run(HttpRequest req, ILogger log)
{
    ...
    using (var http = new HttpClient())
    {
        try
        {
            ...
            log.LogInformation($"appRoleAssignmentRequired={appRoleAssignmentRequired}");
