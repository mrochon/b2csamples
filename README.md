...
| [PromptForSUSI](https://github.com/mrochon/b2csamples/tree/master/Policies/PromptForSUSI)  | Passes whatever prompt parameter was used with B2C to a federated AAD. |
