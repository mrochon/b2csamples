...
| [Email OTP with reCaptch V3](https://github.com/mrochon/b2csamples/tree/master/Policies/EmailOTPWithGoogleRecaptchaV3) | Supports signin with just OTP to user email (no pwd). Uses Google reCaptcha |
